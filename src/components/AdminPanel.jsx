...
import { 
  ...
  AlertTriangle, RefreshCw, Eye, X, Upload, Sparkles, Image as ImageIcon, Check
} from 'lucide-react';
...
export default function AdminPanel() {
  ...
  // Modal Form & Multi-Step Wizard State
              ...
              <div className="wizard-body-container">
                ...
                {wizardStep === 1 && (
                  <div className="wizard-step-content fade-in">
                    <div className="form-row-2">
                      <div className="form-group">
                        <label htmlFor="prodId">Product ID (Unique Number)*</label>
                        <input 
                          type="number" 
                          id="prodId"
                          value={formData.id}
                ...
                {wizardStep === 2 && (
                  <div className="wizard-step-content fade-in">
                    <div className="form-row-2">
                      ...
                      <div className="form-group">
                        <label htmlFor="prodOrigPrice">Original Slash Price (₹)</label>
                        <input 
                          type="number" 
                          id="prodOrigPrice"
                    ...
                    <div className="wizard-image-grid">
                      ...
                      <div className="wizard-image-inputs">
                        <div className="form-group">
                          <label>Upload Saree Image File</label>
                        ...
                        <div className="form-group">
                          <label htmlFor="prodImage">Or Image Path / URL*</label>
                          <input 
                            type="text" 
                            id="prodImage"
